...
def batch_score_videos(base_dir: str,
    ...
    meta = json.load(open('path/to/GroundMoRe/test_v2.json'))['videos']
    ...
    for video_dir_name in tqdm(meta.keys()):
        video_path = os.path.join(base_dir, video_dir_name, 'images')
        ...
        for exp_id in meta[video_dir_name]['questions'].keys():
            # print(f"Processing expression {exp_id}...")
            reference_text = meta[video_dir_name]['questions'][exp_id]['question']
            raw_clip_scores = {}
...
def main():
    ...
    parser.add_argument('--input_dir', default='path/to/GroundMoRe/annotations',
    ...
    parser.add_argument('--output', '-o', default='path/to/video_scores_groundmore.json',

...
def batch_score_videos(base_dir: str,
    ...
    meta = json.load(open('path/to/ref_youtube_vos/meta_expressions/valid/meta_expressions.json'))['videos']
...
def main():
    ...
    parser.add_argument('--input_dir', default='path/to/ref_youtube_vos/valid/JPEGImages',

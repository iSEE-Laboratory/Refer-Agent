...
def batch_score_videos(base_dir: str,
    ...
    meta = json.load(open('path/to/mevis/valid/meta_expressions.json'))['videos']
...
def main():
    ...
    parser.add_argument('--input_dir', default='path/to/mevis/valid/JEPGImages',
    ...
    parser.add_argument('--output', '-o', default='path/to/video_scores_mevis.json',

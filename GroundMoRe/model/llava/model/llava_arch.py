...
class LlavaMetaModel:
    def __init__(self, config):
        ...
        if hasattr(config, "mm_vision_tower"):
            self.vision_tower = build_vision_tower(config, delay_load=True, is_adapted=True)
    ...
    def initialize_vision_modules(self, model_args, fsdp=None):
        ...
        vision_tower = build_vision_tower(model_args, is_adapted=True)
...
class LlavaMetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        if type(images) is list or images.ndim == 5:
            ...
            image_features = self.encode_images(images)  # image size: t 3 224 224 --> t 256 4096

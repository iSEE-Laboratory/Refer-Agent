...
if __name__ == '__main__':
    ...
    parser.add_argument("--visa_pred_path", type=str, default="path/to/mask_results")
    parser.add_argument("--visa_exp_path", type=str, default="path/to/revos/meta_expressions_valid_.json")
    parser.add_argument("--visa_mask_path", type=str, default="path/to/revos/mask_dict.json")
    parser.add_argument("--visa_foreground_mask_path", type=str, default="path/to/revos/mask_dict_foreground.json")
    ...
    for vid_name in exp_dict:
        ...
        for exp in vid['expressions']:
            if os.path.exists(os.path.join(args.visa_pred_path, vid_name, exp)):

...
def save_results(all_boxes, all_points, save_path, frames, img_folder, video_name, save_path_prefix, descriptions, split_frames_idx, exp_id, key_frame_idx, video_predictor):
    if not all_boxes:
        ...
        for frame_name in frames:
            img_path = os.path.join(img_folder, video_name, 'images', frame_name + ".jpg")
        ...
        frame_list = [os.path.join(img_folder, video_name, 'images', frame_name + ".jpg") for frame_name in frames]
